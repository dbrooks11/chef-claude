...
export default function Main(){
    ...
    return(
        <main>
            ...
            {addMoreText()}
            {ingredientsLength > 0 ? <section className="ingredients-container">
                <h2> Ingredients on hand:</h2>
                <ul>
                    {ingredientsListItems}
                </ul>
                {ingredientsLength >= 3 ? <div className="get-recipe-container">
                    <div className="get-recipe-text">
                        <h3>Ready for a recipe?</h3>
                        <span>Generate a recipe from your list of ingredients</span>
                    </div>
                    <button onClick={getRecipeClick}>Get a recipe</button>
                </div> : null}
            </section> : null}
            
            {showRecipe ? <section className="response-container">
